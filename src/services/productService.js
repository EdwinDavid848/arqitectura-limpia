...
import Swal from 'sweetalert2'; // Importa Swal si lo usas en la alerta
import { ref } from 'vue'; // Si usas Vue, ref puede ser útil para variables reactivas
import productService from '@/services/productService'; // Asegúrate de importar correctamente
...
const limit = ref(10); // Establece un valor predeterminado para limit
